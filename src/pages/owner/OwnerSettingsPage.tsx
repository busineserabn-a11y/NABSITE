      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <Card variant="bordered">
          ...
          <div className="space-y-4">
                  ...
                  <button
                    ...
                    onClick={() =>
                      setSettings({
                        ...settings,
                        heroSettings: {
                          ...(settings.heroSettings || { bgType: 'gradient', overlayOpacity: 60, showMotionElements: true }),
                          bgType: bg.id as any,
                        },
                      })
                    }
                    className={`p-3 rounded-xl border text-xs font-bold transition-all text-center ${
                      (settings.heroSettings?.bgType || 'gradient') === bg.id
            ...
            {settings.heroSettings?.bgType === 'image' && (
              <Input
            ...
            {settings.heroSettings?.bgType === 'video' && (
              <Input
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      heroSettings: {
                        ...(settings.heroSettings || { bgType: 'gradient' }),
